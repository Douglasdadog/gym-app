...
export default function MembershipPage() {
  ...
  const purchaseDirect = async (tierId: string, successMessage?: string) => {
    if (!profile) return;
    try {
      ...
      setMessage(successMessage ?? `Successfully upgraded to ${tierId}! Your dashboard will update shortly.`);
    } catch (err: unknown) {
